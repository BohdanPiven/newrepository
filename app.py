    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .segment-item, .prefix-item, .potential-client-group {
                display: flex;
                align-items: center;
                margin-bottom: 8px;
            }
            ...
            .segment-label, .prefix-label, .potential-client-group-label {
                font-size: 13px;
            ...
            .email-item, .company-item, .client-item, .subitem-item {
                display: flex;
                align-items: center;
                margin-bottom: 5px;
            }
