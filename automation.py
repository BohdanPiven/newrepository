...
def automation_tiktok_plan():
    ...
    posts = (
        ScheduledPost.query.filter_by(user_id=uid)
...
def automation_tiktok_timeline():
    tpl = """<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8">
      ...
      <style>
        ...
        .card{max-width:900px;margin:20px auto;background:#fff;padding:20px;
...
# ── Strony statyczne: Rodzaje, Scenariusze ──────────────────────────
@automation_bp.route("/tiktok/rodzaje")
def automation_tiktok_rodzaje():
    tpl = """<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8">
    <title>Rodzaje wideo</title></head><body style="font-family:Arial,sans-serif;padding:20px">
      <h1>Rodzaje wideo na TikToku</h1><p>Poradniki, Q&A, kulisy pracy itp.</p>
      <p><a href="{{ url_for('automation.automation_tiktok') }}">← Powrót</a></p>
    </body></html>"""
    return render_template_string(tpl)
...
def automation_tiktok_scenariusze():
    tpl = """<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8">
    <title>Scenariusze</title></head><body style="font-family:Arial,sans-serif;padding:20px">
      <h1>Scenariusze Postów i Wytyczne</h1><p>Przykładowe schematy i wytyczne.</p>
      <p><a href="{{ url_for('automation.automation_tiktok') }}">← Powrót</a></p>
    </body></html>"""
    return render_template_string(tpl)

# ── Nowy route – Upload wideo ───────────────────────────────────────
...
def automation_tiktok_video():
    ...
    try:
        ...
        # 2) UPLOAD binarnie (PUT, bez tokenu w URL)
...
def automation_facebook():
    tpl = """<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8">
    <title>Facebook</title></head><body style="font-family:Arial,sans-serif;padding:20px">
...
def automation_facebook_publish():
    if request.method == "GET":
        return render_template_string("""<!DOCTYPE html><html lang="pl"><head><meta charset="UTF-8">
          <title>Publikuj na FB</title></head><body style="font-family:Arial,sans-serif;padding:20px">
