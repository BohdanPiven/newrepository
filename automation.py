    ...
    <head>
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .container{max-width:600px;margin:20px auto;background:#fff;padding:20px;box-shadow:0 4px 8px rgba(0,0,0,0.1);position:relative;}
        .back-button{position:absolute;top:10px;left:10px;font-size:14px;text-decoration:none;color:#fff;background:#1f8ef1;padding:6px 10px;border-radius:4px;display:inline-flex;align-items:center;}
...
automation_bp.route('/', endpoint='automation_home')(automation_home)
...
def automation_tiktok():
    ...
    <head>
      ...
      <style>
        ...
        .login-link,.logout-link{display:inline-block;margin-top:20px;padding:10px 15px;background:#1f8ef1;color:#fff;text-decoration:none;border-radius:4px;}
...
def automation_tiktok_rodzaje():
    ...
    <!DOCTYPE html>
    <html lang="pl">
    <head><meta charset="UTF-8"><title>Rodzaje wideo</title></head>
    <body>
      <h1>Rodzaje wideo</h1>
...
def automation_tiktok_scenariusze():
    ...
    <!DOCTYPE html>
    <html lang="pl">
    <head><meta charset="UTF-8"><title>Scenariusze</title></head>
    <body>
